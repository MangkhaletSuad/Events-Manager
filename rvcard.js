  ...
  render () {
    ...
    <ha-card header="Hello ${hass.user.name}!">
          <div class="card-content">
            ${this.cameras.filter((c) => c.access+token).map((camera) => {
              let thumbClass = camera.hass_motion ? "thumb moton" : "thumb";
    ...
    static get styles() {
      return css`
        ...
        ha-card.card_content-left {
        }
  
        ha-card.card_content-right {
          flex-direction: row-reverse;
        }
  
        ha-card.card_content-top {
          flex-direction: column;
        }
  
        ha-card.card_content-top .card_content {
          display: flex;
          flex: unset;
        }
  
        ha-card.card_content-bottom {
          flex-direction: column-reverse;
        }
  
        ha-card.card_content-bottom .card_content {
          display: flex;
          flex: unset;
        }
  
        ha-card.card_content-none .card_content {
          display: none;
        }
